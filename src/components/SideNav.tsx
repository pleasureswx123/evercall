  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-20 bg-black bg-opacity-80 border-r border-cyber-blue border-opacity-30 z-50">
      <div className="flex flex-col items-center py-8 space-y-8">
        ...
        <div className="flex flex-col space-y-6 text-xs font-sans">
          <button
          ...
          >
            <div className='text-[10px]'>INDEX</div>
          ...
          >
            <div className='text-[9px]'>CHARACTER</div>
          ...
          >
            <div className='text-[9px]'>NEWS</div>
          ...
          >
            <div className='text-[9px]'>TECH</div>
          ...
          >
            <div className='text-[9px]'>ABOUT</div>
