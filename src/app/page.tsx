      ...
      <nav className="fixed left-0 top-0 h-full w-20 bg-black bg-opacity-80 border-r border-cyber-blue border-opacity-30 z-50">
        <div className="flex flex-col items-center py-8 space-y-8">
          ...
          <div className="flex flex-col space-y-6 text-xs font-mono">
            <a href="#index" className="text-cyber-blue hover:text-white transition-colors">
              <div>INDEX</div>
              <div className="text-white">首页</div>
            </a>
            <a href="#characters" className="text-gray-400 hover:text-cyber-blue transition-colors">
              <div>CHARACTER</div>
              <div className="text-white">角色</div>
            </a>
            <a href="#news" className="text-gray-400 hover:text-cyber-blue transition-colors">
              <div>NEWS</div>
              <div className="text-white">新闻</div>
            </a>
            <a href="#tech" className="text-gray-400 hover:text-cyber-blue transition-colors">
              <div>TECH</div>
              <div className="text-white">技术</div>
            </a>
            <a href="#experience" className="text-gray-400 hover:text-cyber-blue transition-colors">
              <div>EXPERIENCE</div>
