  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="ml-20 min-h-screen">
        ...
        <section id="about" className="min-h-screen bg-dark-100 border-t border-cyber-blue border-opacity-30 p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <div className="text-white font-orbitron text-3xl mb-4">关于我们</div>
        ...
        {/* 团队介绍区块 */}
        <section className="min-h-screen bg-black border-t border-cyber-blue border-opacity-30 p-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="text-cyber-blue font-mono text-sm mb-2">CORE TEAM ://</div>
              <div className="text-white font-orbitron text-3xl mb-8">核心团队</div>
            </div>
